...
public class ComentariosService_2 extends GenericServiceImplementation implements ServiceInterface {

    public ComentariosService_2(HttpServletRequest oRequest) {
        super(oRequest);
