...
public class ComentariosDao_2 extends GenericDaoImplementation implements DaoInterface {

    public ComentariosDao_2(Connection oConnection, String ob, UsuarioBean oUsuarioBeanSession) {
