...
moduleCommon.controller('homeController', ['$scope', '$http', '$location', 'toolService', 'sessionService', '$window',
    function ($scope, $http, $location, toolService, sessionService, $window) {
