...
//        }
//        ;
//        $scope.lineasFactura = function (id) {
//            $http({
//                method: 'GET',
//                url: 'json?ob=linea&op=getlineafactura&rpp=10000&page=1&id=' + id
//            }).then(function (response) {
//                $scope.status = response.status;
...
//                    usuario = $scope.ajaxDataUsuarios[i].obj_Usuario.nombre + ' ' + $scope.ajaxDataUsuarios[i].obj_Usuario.ape1 + '' + $scope.ajaxDataUsuarios[i].obj_Usuario.ape2;
//                    fecha = $scope.ajaxDataUsuarios[i].fecha;
//                    lineasTotales = $scope.ajaxDataUsuarios[i].link_linea;
//                }
//            }
//            ;
...
//            doc.setFontSize(16);
//            doc.setFontType('normal');
//            doc.text(125, 40, 'Cliente. Pedro Ramirez Jose');
//            doc.text(125, 60, 'Fecha. 25/11/2018');
...
//                doc.text(170, linea, (parseFloat(($scope.ajaxLineasFactura[x].obj_Producto.precio * $scope.ajaxLineasFactura[x].cantidad)).toFixed(2).toString()));
//                linea = linea + 13;
//            }
//
//            //FOOTER DE FACTURA
